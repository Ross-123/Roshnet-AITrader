...
const Watchlist = () => {
  ...
  const searchStocks = async (query) => {
    ...
    setIsSearching(true);
    try {
      // Direct Finnhub API call (you'll need to adjust CORS on backend)
      const response = await api.get('/finnhub/search', {
        params: { q: query }
      });

      // Finnhub API returns { count: number, result: [] }
      ...
      setSearchResults(getMockStockSuggestions(query));
      setShowDropdown(true);
    } finally {
  ...
  const getMockStockSuggestions = (query) => {
    const mockStocks = [
      { symbol: 'AAPL', description: 'Apple Inc', type: 'Common Stock', displaySymbol: 'AAPL' },
      { symbol: 'GOOGL', description: 'Alphabet Inc', type: 'Common Stock', displaySymbol: 'GOOGL' },
      ...
      { symbol: 'JPM', description: 'JPMorgan Chase & Co', type: 'Common Stock', displaySymbol: 'JPM' },
      { symbol: 'V', description: 'Visa Inc', type: 'Common Stock', displaySymbol: 'V' },
      { symbol: 'JNJ', description: 'Johnson & Johnson', type: 'Common Stock', displaySymbol: 'JNJ' },
    ];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            <div className="relative flex-grow sm:max-w-xs">
              <input
                ...
                className={`w-full pl-10 pr-4 py-2 rounded-xl border ${theme === 'dark'
                  ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-400'
                  : 'bg-white border-gray-200 placeholder-gray-400'
                  } focus:outline-none focus:ring-2 focus:ring-blue-500`}
              />
              <HiSearch className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'
                }`} />
            </div>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <motion.div
            ...
            className={`relative p-6 rounded-2xl overflow-hidden ${theme === 'dark'
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className={`p-3 rounded-xl backdrop-blur-sm ${theme === 'dark' ? 'bg-blue-500/20 border border-blue-500/30' : 'bg-blue-100/80 border border-blue-200/50'
                  }`}>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className={`p-3 rounded-xl backdrop-blur-sm ${theme === 'dark' ? 'bg-green-500/20 border border-green-500/30' : 'bg-green-100/80 border border-green-200/50'
                  }`}>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className={`p-3 rounded-xl backdrop-blur-sm ${theme === 'dark' ? 'bg-purple-500/20 border border-purple-500/30' : 'bg-purple-100/80 border border-purple-200/50'
                  }`}>
        ...
        {error && (
          <div
            className={`mb-6 p-4 rounded-xl border ${theme === 'dark'
        ...
        {/* Watchlist Table */}
        <div
          className={`relative rounded-2xl overflow-hidden ${theme === 'dark'
            ? 'bg-[#1f1f1f]/80 border border-white/10 backdrop-blur-md'
            : 'bg-white/80 border border-gray-200 backdrop-blur-md'
            } shadow-lg`}
        >
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className={`${theme === 'dark'
                  ...
                  <tr>
                    <th className={`px-6 py-4 text-left text-xs font-semibold tracking-wider uppercase ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                      }`}>Stock</th>
                    <th className={`px-6 py-4 text-left text-xs font-semibold tracking-wider uppercase ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                      }`}>Current Price</th>
                    <th className={`px-6 py-4 text-left text-xs font-semibold tracking-wider uppercase ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
            ...
            <form onSubmit={handleAddStock}>
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-3 py-3 text-base rounded-xl border-2 transition-all duration-200 focus:outline-none focus:ring-4 ${theme === 'dark'
                  ...
                  {showDropdown && searchResults.length > 0 && (
                    <div className={`absolute z-10 w-full mt-1 rounded-xl border-2 shadow-xl max-h-60 overflow-y-auto ${theme === 'dark'
                      ...
                      {searchResults.map((stock, index) => (
                        <button
                          ...
                          className={`w-full px-4 py-3 text-left hover:bg-blue-500 hover:text-white transition-colors ${theme === 'dark'
                        ...
                        >
                          <div className="flex justify-between items-center">
                            ...
                            <div className={`text-xs px-2 py-1 rounded ${theme === 'dark' ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-600'
                              }`}>
                ...
                {newStock.ticker && newStock.name && (
                  <div className={`p-3 rounded-xl border-2 ${theme === 'dark'
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className={`text-xs px-2 py-1 rounded ${theme === 'dark' ? 'bg-blue-600 text-white' : 'bg-blue-100 text-blue-700'
                        }`}>
                        Selected
                      </div>
                    </div>
              ...
              <div className="mt-6 flex justify-end space-x-3">
                <button
                  type="button"
                  onClick={handleModalClose}
                  className={`px-4 py-2 rounded-xl font-semibold transition-all duration-200 ${theme === 'dark'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl ${newStock.ticker && newStock.name
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    disabled
                    className={`w-full px-3 py-3 text-base rounded-xl border-2 ${theme === 'dark'
      ...
      {showViewModal && selectedStock && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div
            className={`w-full max-w-3xl p-6 rounded-2xl shadow-2xl ${theme === 'dark'
              ? 'bg-[#1f1f1f] border border-gray-600'
              : 'bg-white border border-gray-200'
              }`}
          >
